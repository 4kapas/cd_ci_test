    ...
    redraw_node: function (node, deep, is_callback, force_render) {
      ...
      if ((obj.icon && obj.icon !== true) || obj.icon === false) {
        if (obj.icon === false) {
          ...
          node.childNodes[1].childNodes[0].style.fontSize = "15px";
          node.childNodes[1].childNodes[0].style.color = "#444951";
          node.childNodes[1].childNodes[0].style.fontWeight = 400;
          node.childNodes[1].childNodes[0].style.fontFamily = "Pretendard";
          node.childNodes[1].childNodes[0].className +=
