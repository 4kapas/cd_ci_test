...
export class PropertiesPanel {
  ...
  set(object) {
    ...
    if (object instanceof PointCloudTree) {
      ...
      console.log(object, "inSphereGeometry");
  ...
  setPointCloud(pointcloud) {
...

    {
      ...
      // yang 23/04/20 기준 초기값은 0으로 설정해야함 value : material.size -> 0 으로변경
      material.size = 0;
      sldPointSize.slider({
        value: material.size,
        min: 0,
  ...
  setMeasurement(object) {
    console.log(object, "setMeasurement type");
    let TYPE = {
    ...
    let getType = (measurement) => {
      console.log("gettypes", measurement);
